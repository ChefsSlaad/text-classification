...
class WordFrequencyAnalyzer_tests(unittest.TestCase):
    def setUp(self):
        ...
        self.in_3 = r"""
            ...
            if name           Tell this soul with sorrow laden if, within the distant Aidenn,
        ...
        self.textblocks = (self.in_1, self.in_2, self.in_3, self.in_4, self.in_5)

    def tearDown(self):
        pass

    def test_Tokenize(self):
        expected_result  = ["The", "sun", "shines", "over", "the", "lake"]
        self.assertEqual(normalization.tokenize(self.in_1), expected_result)

    def test_remove_accent_characters(self):
        for textblock in self.textblocks:
            for word in normalization.tokenize(textblock):
                print(word, normalization.remove_accent_characters(word))
